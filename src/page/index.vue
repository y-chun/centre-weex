<template>
  <div class='index-body'>
    ...
    <div class="index-list-container">
      <image src='local:///cha.png'
             class="index-limage"></image>
      <div class="index-list">
        <div class="index-list-cell">
          <text class="index-lcell-text">夜间休息</text>
          <c-switch class="index-switch"></c-switch>
        </div>
        <div class="index-list-cell"
             @click="jump('/time/start')">
    ...
    <div class="index-bom">
      <div class='index-bom-top'>
        <image src='local:///clock.png' class="index-btop-img"></image>
